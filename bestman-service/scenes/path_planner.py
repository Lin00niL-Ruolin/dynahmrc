...
class AStarPathPlanner:
    ...
    OBSTACLES = {
        'scene1': [
            ...
            # 家具（准确碰撞框，来自 PyBullet AABB 测量）
            # 注：R=0.3 半径在构造函数中用 margin 展开
            (9.0, 0.1, 1.2, 1.2),     # fridge
            (7.0, 0.2, 1.2, 1.0),    # elementA
            (5.5, 0.2, 1.2, 1.0),    # elementB1
            (8.3, 0.1, 1.0, 1.0),    # elementC
            (7.8, 0.0, 1.0, 0.9),    # microwave
            (2.5, 1.6, 1.6, 1.2),    # dining table
            # 桌子新一 AABB: x=7.75-9.25, y=3.5-4.5 → 用准确值
            # 桌子碰撞框缩小到桌面中心（底座可从旁边走过）
            (8.1, 3.7, 0.8, 0.6),   # table_new_1 中心
            (8.1, 5.2, 0.8, 0.6),   # table_new_2 中心
            # 椅子 AABB 实测
            (7.18, 4.73, 0.58, 0.54), # chair_4
            (8.18, 2.73, 0.58, 0.54), # chair_3
